...
## 📄 Sobre o Projeto
O **Cartório-Check IA** é um planejamento de produto digital desenvolvido para **Cartórios de Registro de Imóveis**. O projeto visa resolver o gap de comunicação entre a falha de sistemas digitais (como queda do site) e a tomada de decisão da gestão.
...
Consulte a [Documentação Técnica](./docs) para detalhes sobre a implementação da IA.
